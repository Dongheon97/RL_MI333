...
class MjCartPole():
    ...
    def finish_episode(self, gamma=0.99):
        ...
        #wandb.log({'actor loss': torch.stack(policy_losses).sum()})
        #wandb.log({'critic loss': torch.stack(value_losses).sum()})
        #wandb.log({'loss': loss})
    ...
    def main(self):
        ...
        for i_episode in range(10000):
            ...
            #wandb.log({'Average reward': running_reward})
